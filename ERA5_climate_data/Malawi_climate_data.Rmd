...
precip <- rast('ERA5_precipitation_malawi_2015_2024.nc')  # Humidity
```
...
write.csv(malawi_monthly_precip,
          "malawi_monthly_precipitation.csv",
          row.names = FALSE)
```
...
```{r}
# note that we choose var_name
malawi_monthly_temperature <- ERA5_monthly_data(temp, mwi, var_name = "temperature")
head(malawi_monthly_temperature)

write.csv(malawi_monthly_temperature,
          "malawi_monthly_temperature.csv",
          row.names = FALSE)
```
