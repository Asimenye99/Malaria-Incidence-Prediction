...
SARIMA_forecasts <- forecast_SARIMAs(sarima_models, h = 4)

# Plot national forecast
BASELINE_forecasts <- forecast_baselines(baseline_models, h = 4)

# Plot national forecast
#SARIMAX_forecasts <- forecast_baselines(sarimax_models, h = 4)
```
